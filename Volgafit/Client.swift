...
class Client: Person {
    ...
    init(id: Int? = nil, firstName: String, lastName: String, imagePath: String?, birthDate: Date?, street: String?, city: String?, country: String?, zipCode: String?, phone: String?, email: String?, social: [String]?, workouts: [Workout]?) {
    ...
    required convenience init?(with json: JSON) {
        ...
        self.init(id: id, firstName: firstName, lastName: lastName, imagePath: imagePath, birthDate: birthDate, street: street, city: city, country: country, zipCode: zipCode, phone: phone, email: email, social: social, workouts: workouts)
    }
}
